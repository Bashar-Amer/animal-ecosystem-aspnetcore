    ...
    public static class DbContextExtensions
    {
        public static class SeedData
        {
            public static async Task SeedAsync(IServiceProvider services)
            {
                ...
                var bid1 = new Bid { AuctionId = auction1.Id, UserId = buyer1.Id, Amount = 420, PlacedAt = DateTime.UtcNow.AddMinutes(-20) };
                var bid2 = new Bid { AuctionId = auction1.Id, UserId = buyer1.Id, Amount = 380, PlacedAt = DateTime.UtcNow.AddHours(-1) };
                var bid3 = new Bid { AuctionId = auction2.Id, UserId = buyer1.Id, Amount = 12500, PlacedAt = DateTime.UtcNow.AddMinutes(-10) };

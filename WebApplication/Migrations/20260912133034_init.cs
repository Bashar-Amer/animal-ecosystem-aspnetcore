        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabilityWindow = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    AvailabilityText = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsFeatured = table.Column<bool>(type: "bit", nullable: false),
                    Credential = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VetProfiles_AspNetUsers_VerifiedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreederNotes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    ModeratedByAdminId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Animals_AspNetUsers_ModeratedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VeterinaryServices_VetProfiles_VetProfileId",
                        column: x => x.VetProfileId,
                        principalTable: "VetProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VetFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VetFavorites_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VetFavorites_VetProfiles_VetProfileId",
                        column: x => x.VetProfileId,
                        principalTable: "VetProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeLabel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VetScheduleSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VetScheduleSlots_VetProfiles_VetProfileId",
                        column: x => x.VetProfileId,
                        principalTable: "VetProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VetTimelineEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VetTimelineEvents_VetProfiles_VetProfileId",
                        column: x => x.VetProfileId,
                        principalTable: "VetProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalHealthRecords", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Auctions_AspNetUsers_ModeratedByAdminId",
                        column: x => x.ModeratedByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VetReviews_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VetReviews_AspNetUsers_ReviewerId",
                        column: x => x.ReviewerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VetReviews_VetProfiles_VetProfileId",
                        column: x => x.VetProfileId,
                        principalTable: "VetProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalHealthRecords_AnimalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Animals_ModeratedByAdminId",
                table: "Animals",
                column: "ModeratedByAdminId",
                unique: true,
                filter: "[ModeratedByAdminId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auctions_ModeratedByAdminId",
                table: "Auctions",
                column: "ModeratedByAdminId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VeterinaryServices_VetProfileId",
                table: "VeterinaryServices",
                column: "VetProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_VetFavorites_UserId_VetProfileId",
                table: "VetFavorites",
                columns: new[] { "UserId", "VetProfileId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VetFavorites_VetProfileId",
                table: "VetFavorites",
                column: "VetProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VetProfiles_VerifiedByAdminId",
                table: "VetProfiles",
                column: "VerifiedByAdminId",
                unique: true,
                filter: "[VerifiedByAdminId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_VetReviews_AppointmentId",
                table: "VetReviews",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_VetReviews_ReviewerId",
                table: "VetReviews",
                column: "ReviewerId");

            migrationBuilder.CreateIndex(
                name: "IX_VetReviews_VetProfileId",
                table: "VetReviews",
                column: "VetProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_VetScheduleSlots_VetProfileId",
                table: "VetScheduleSlots",
                column: "VetProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_VetTimelineEvents_VetProfileId",
                table: "VetTimelineEvents",
                column: "VetProfileId");
        }
